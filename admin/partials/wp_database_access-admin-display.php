 ...
 * @subpackage Wp_database_access/admin/partials
 */
?>
...
class AdminerForWP {
	...
	public function on_show_page() {
		...
		<div class="wrap">
			...
			<p><a href="http://www.adminer.org/">Adminer</a> <?php _e( '(formerly phpMinAdmin) is a full-featured MySQL management tool written in PHP.', 'adminer' ); ?><br>
																	   <?php
																		_e( 'Current used version of Plugin', 'adminer' );
																		echo ' ' . self::get_plugin_data( 'Name' ) . ': ' . self::get_plugin_data( 'Version' );
																		?>
			</p>
			<br class="clear"/>
